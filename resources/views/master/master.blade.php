...
<head>
    ...
    <meta name="description" content="ini web page di buat pake tailwindcss, alpinejs, laravel">
    <meta name="author" content="Amru Fakharullah | amruspace">
...
<body class="dark:bg-gray-800">
    ...
    <script>
        ...
        let sunSvg = document.getElementById('sun');
